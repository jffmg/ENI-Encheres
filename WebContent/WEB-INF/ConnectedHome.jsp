				...
				<div class="container2">
					<div>
						...
						<label class="selectBoxTitle"> <input type="radio"
							name="buyOrSell" value="buy1" onClick="checkBoxes()" checked>
							Achats
						</label> <br>
						<br> <input type="radio" name="buy2" class="checkBox"
							id="openBids" value="openBids" checked> <label
						...
						<br> <input type="radio" name="buy2" class="checkBox"
							...
							class="selectBoxLabel">mes enchères remportées</label>
			...
			<div class="divArticle">
				...
				<div class="container2">
					<img class="articleImg" alt="Object"
						src="images/objet_à_vendre.jpg">
					<div class="articleInfo">
						Prix : ${element.getSalePrice()} point(s) <br> Meilleure
						enchère : 0 point(s)<br> Fin de l'enchère :
